#NEC TOWERS INFO
#____
LEW_22_CH4_95 <- read.csv("/Users/reneechabot/Desktop/towers/LEW-2022-ch4-95m-1-hour-20230425.csv")
...
LEW_22_CH4_50 <- read.csv('/Users/reneechabot/Desktop/towers/LEW-2022-ch4-50m-1-hour-20230425.csv')
...
LEW_22_CO2_95 <- read.csv('/Users/reneechabot/Desktop/towers/LEW-2022-co2-95m-1-hour-20230425.csv')
...
LEW_22_CO2_50 <- read.csv('/Users/reneechabot/Desktop/towers/LEW-2022-co2-50m-1-hour-20230425.csv')
...
#_________
TMD_22_CH4_113 <- read.csv('/Users/reneechabot/Desktop/towers/TMD-2022-ch4-113m-1-hour-20230425.csv')
...
TMD_22_CH4_49 <- read.csv('/Users/reneechabot/Desktop/towers/TMD-2022-ch4-49m-1-hour-20230425.csv')
...
TMD_22_CO2_113 <- read.csv('/Users/reneechabot/Desktop/towers/TMD-2022-co2-113m-1-hour-20230425.csv')
...
TMD_22_CO2_49 <- read.csv('/Users/reneechabot/Desktop/towers/TMD-2022-co2-49m-1-hour-20230425.csv')
...
#_________
BVA_22_CH4_111 <- read.csv('/Users/reneechabot/Desktop/towers/BVA-2022-ch4-111m-1-hour-v20250319.csv')
...
BVA_22_CH4_50 <- read.csv('/Users/reneechabot/Desktop/towers/BVA-2022-ch4-50m-1-hour-v20250319.csv')
...
BVA_22_CO2_111 <- read.csv('/Users/reneechabot/Desktop/towers/BVA-2022-co2-111m-1-hour-v20250319.csv')
...
BVA_22_CO2_50 <- read.csv('/Users/reneechabot/Desktop/towers/BVA-2022-co2-50m-1-hour-v20250319.csv')
...
xlim_vals <- c(as.POSIXct("2022-10-20 00:00:00"),
               as.POSIXct("2022-10-20 23:00:00"))
#ch4
plot(
...
TOWER_LOCATIONS <- read.csv("/Users/reneechabot/Desktop/towers/NEC_sites.csv")
...
CT_CO2 <- list()
files <- list.files(
  '/Users/reneechabot/Desktop/towers/ct/oct/co2',
  pattern = '*.nc',
  full.names = TRUE
)
...
library(raster)
files = list.files(
  '/Users/reneechabot/Desktop/towers/ct/oct/ch4',
  pattern = '*.nc',
  full.names = TRUE
)
for (i in seq_along(files)) {
